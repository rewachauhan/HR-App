...
public class ElectricityActivity extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		b.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View arg0) {
				...
				SQLiteDatabase mydatabase = openOrCreateDatabase("mydb.dat",MODE_PRIVATE,null);
				 mydatabase.execSQL("CREATE TABLE IF NOT EXISTS Elec( Date VARCHAR, Time VARCHAR );");
				 mydatabase.execSQL("INSERT INTO Elec VALUES('"+date+"','"+time+"');");
		...
		tv.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View arg0) {
				// TODO Auto-generated method stub
				startActivity(new Intent(getApplicationContext(),FeedEActivity.class));
